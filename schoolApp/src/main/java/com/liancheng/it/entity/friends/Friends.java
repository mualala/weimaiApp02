...
public class Friends implements Serializable {
	...
	private String see_type;//0=没看过朋友的朋友；1=看过碰过的朋友
	...
	private List<Friends> fTofriends;//用于朋友的朋友
	...
	/**
	 * @param see_type the see_type to set
	 */
	public void setSee_type(String see_type) {
	...
	/**
	 * @return the fTofriends
	 */
	public List<Friends> getfTofriends() {
		return fTofriends;
	}

	/**
	 * @param fTofriends the fTofriends to set
	 */
	public void setfTofriends(List<Friends> fTofriends) {
		this.fTofriends = fTofriends;
	}
	...
	public String toString() {
		return "Friends [user_id=" + user_id + ", f_user_id=" + f_user_id
				...
				+ fans_see_state + ", type=" + type + ", see_type=" + see_type
				+ ", f_creatime=" + f_creatime + ", profile=" + profile
				+ ", user_nickname=" + user_nickname + ", school=" + school
				+ ", major=" + major + ", gender=" + gender + ", birthday="
				+ birthday + ", fTofriends=" + fTofriends + "]";
	}
